...
from utils.utils import load_checkpoint, load_config, save_checkpoint, update_config
...
def parse_arguments():
    parser = argparse.ArgumentParser(description='Arguments for training MHD PINO')
...
if __name__ == '__main__':
    ...
    mhd_dataloader_train = MHDDataloader(dataset_train, sub_x=dataset_params['sub_x'], sub_t=dataset_params['sub_t'], ind_x=dataset_params['ind_x'], ind_t=dataset_params['ind_t'])
    mhd_dataloader_val = MHDDataloader(dataset_val, sub_x=dataset_params['sub_x'], sub_t=dataset_params['sub_t'], ind_x=dataset_params['ind_x'], ind_t=dataset_params['ind_t'])
