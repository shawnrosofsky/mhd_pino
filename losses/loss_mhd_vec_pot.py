...
class LossMHDVecPot(LossMHD):
    def __init__(self, nu=1e-4, eta=1e-4, rho0=1.0, 
                 ...
                 **kwargs): # add **kwargs so that we ignore unexpected kwargs when passing a config dict):
    ...
    def data_loss(self, pred, true, return_all_losses=False):
        ...
        loss_data = (self.u_weight*loss_u + self.v_weight*loss_v + self.A_weight*loss_A) / weight_sum
    ...
    def ic_loss(self, pred, input, return_all_losses=False):
        ...
        loss_ic = (self.u_weight*loss_u_ic + self.v_weight*loss_v_ic + self.A_weight*loss_A_ic) / weight_sum
    ...
    def mhd_pde_loss(self, Du, Dv, DA, return_all_losses=None):
        ...
        loss_pde = (self.Du_weight*loss_Du + self.Dv_weight*loss_Dv + self.DA_weight*loss_DA) / weight_sum
